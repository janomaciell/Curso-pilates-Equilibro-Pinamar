        ...
        <div className="auth-grid">
          ...
          <div className="auth-left">
            ...
            <div className="auth-brand">
              ...
              <h1 className="brand-title">Pilates</h1>
              <p className="brand-tagline">Tu camino hacia una práctica de Pilates</p>
            </div>

            <div className="auth-benefits">
              <p className="benefits-title">¿Por qué unirte?</p>
            ...
            <div className="auth-testimonial">
              ...
              <p className="testimonial-text">
                Las clases cambiaron mi vida. Hoy me siento más fuerte, alineada y con mucha más energía en mi día a día.
              </p>
          ...
          <div className="auth-right">
            <div className="auth-form-container">
              ...
              <div className="form-header">
                <h2 className="form-title">¡Bienvenida<br />de vuelta!</h2>
                <p className="form-subtitle">Ingresá tus datos para continuar aprendiendo</p>
              </div>
              ...
              <div className="form-footer">
                <p className="footer-text">
                  ...
                  <Link to="/register" className="footer-link">
                    Registrate gratis <FiArrowRight />
                  </Link>
                </p>
              </div>
