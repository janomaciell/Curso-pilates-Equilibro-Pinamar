    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_type', models.CharField(choices=[('video', 'Video'), ('document', 'Documento')], default='video', max_length=20, verbose_name='Tipo')),
                ('video_id', models.CharField(blank=True, help_text='ID del video en Cloudflare Stream', max_length=200, verbose_name='ID del video')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to='lessons/documents/', verbose_name='Archivo')),
