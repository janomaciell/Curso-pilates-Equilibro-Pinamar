...
class MercadoPagoService:
    ...
    def create_preference(self, course, user, return_url, notification_url):
        ...
        try:
            ...
            # Si MP no devuelve sandbox_init_point (ej. token de producción), derivar URL sandbox
            if not sandbox_init_point and init_point and "sandbox." not in init_point:
                # Soporta www.mercadopago.com.ar y mercadopago.com.ar
                ...
                logger.warning("[MP] sandbox_init_point derivado de init_point (usar Credenciales de prueba para pruebas reales).")
